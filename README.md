...
It also works fully offline using cached snapshots and local fallback agents.
...
Portable agent runtime (runs on GitHub, local machines, or offline)
...
VolatiAI will generate both JSON and HTML dashboards for the selected tier.
